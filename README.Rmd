...
A workflow run everyday to get all NBA odds for the night. The results are in `inst/extdata`. An other workflow run every morning to collect odds for shiny app.
